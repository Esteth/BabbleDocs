...
Now that you've assembled your DIY Babble Tracker, you need to flash the firmware for it. This guide uses the wired/wireless `wroom` setup for a Wroom board, although the setup process is similar for other boards such as Xiao S3 Sense using the `xiaos3sense` setup.
